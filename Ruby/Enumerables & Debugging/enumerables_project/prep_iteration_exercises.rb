...
def substrings(string)
  subs = []
  outer_iterator = 0
  while outer_iterator < string.length
    inner_iterator = outer_iterator
    while inner_iterator < string.length
      subs << string[outer_iterator..inner_iterator]
      inner_iterator += 1
    end
    outer_iterator += 1
  end
...
def subwords(word, dictionary)
  substrings(word).select do |subs|
    dictionary.include?(subs)
  end
end
